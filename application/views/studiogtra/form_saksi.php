	    ...
	    <div class="x_panel">
	        <div class="x_content">
				<div class="col-md-12 box-body">
					<form id="form-tambah" method="post" action="<?php echo base_url().'/'.$this->uri->segment(1).'/'.$this->uri->segment(2).'/'.$this->uri->segment(3).'?search='.$this->input->get('search');?>">
						<div class='col-sm-12'>
							<div class='col-sm-4'>
								<div class='form-group'>
									<label>Dusun</label>
									<input type='text' name='nib' disabled value='<?=$kecamatan['name_dsn'];?>' class='form-control' placeholder='no. nib'>
								</div>
							</div>
							<div class='col-sm-4'>
								<div class='form-group'>
                ...
                <div class='col-sm-6'>
                  <div class='form-group col-sm-8'>
                    <label>NIK</label> :
                    <input type='text' name='niksaksi1' id='niksaksi1' class='form-control' value='<?= $template['niksp1_sgt'];?>' placeholder='nik lengkap'>
                  </div>
									<div class='col-sm-4'>
                ...
                <div class='col-sm-6'>
                  <div class='form-group col-sm-8'>
                    <label>NIK</label> :
                    <input type='text' name='niksaksi2' id='niksaksi2' class='form-control' value='<?= $template['niksp2_sgt'];?>' placeholder='nik saksi 2'>
                  </div>
									<div class='col-sm-4'>
										<label>Cek Dukcapil</label>
