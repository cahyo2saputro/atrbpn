...
class Ajax extends CI_Controller {
    ...
    public function getberkas() {
      ...
      if($jenis=='SU'){
        ...
        $file_pdf_kosong = 'http://103.153.186.245:7092/digitalisasi/'.strtoupper($data['nma_kec']).'/'.str_replace(' ','_',strtoupper($data['nma_kel'])).'/SURAT_UKUR/SU_'.$data['kd_full'].'_'.$data['no_su'].'_'.$data['thn_su'].'.pdf#toolbar=0';
        ?>
        <embed id='wide' style='width:100%;height:600px' src='<?= $file_pdf_kosong; ?>'>
        <embed id='mobile' style='width:100%;height:600px' src='https://docs.google.com/viewer?url=<?= $file_pdf_kosong."&embedded=true"; ?>'>
        <?php
        ...
        $file_pdf_kosong = 'http://103.153.186.245:7092/digitalisasi/'.strtoupper($data['nma_kec']).'/'.str_replace(' ','_',strtoupper($data['nma_kel'])).'/BUKU_TANAH/BT_'.$data['nohakfile'].'.pdf#toolbar=0';
        ?>
        <embed id='wide' style='width:100%;height:600px' src='<?= $file_pdf_kosong; ?>'>
        <embed id='mobile' style='width:100%;height:600px' src='https://docs.google.com/viewer?url=<?= $file_pdf_kosong."&embedded=true"; ?>'>
        <?php
