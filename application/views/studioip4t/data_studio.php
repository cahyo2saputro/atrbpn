					...
					<div class="col-sm-12 table-responsive">
						<table id="data-staff" class="table table-bordered">
							<thead>
								...
								<tr>
									<th style="text-align: center;">Target K4</th>
									<th style="text-align: center;">Selesai</th>
									<th style="text-align: center;">Sisa</th>
									<th style="text-align: center;">Target PBT</th>
									<th style="text-align: center;">Selesai</th>
									<th style="text-align: center;">Sisa</th>
								</tr>
							</thead>
...
<script type="text/javascript">
	$(document).ready(function () {
		...
		$('#tabel-body').on('click','#btn-cari-kelurahan',function () {
			...
			window.open('<?=base_url()?>studioip4t_1/index/?search='+s_filter,'_self',false);
		});

		$('#cari_filter').on('click',function () {
			var s_filter = $('#filter_kecamatan').val();
			var s_filterkelurahan = $('#filter_kelurahan').val();
			window.open('<?=base_url()?>studioip4t/?filter='+s_filter+'&filterkelurahan='+s_filterkelurahan,'_self',false);
		})
