...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  <?php
      ...
      if (in_array(132, $_SESSION['menu']) || in_array(47, $_SESSION['menu']) || in_array(80, $_SESSION['menu']) || in_array(28, $_SESSION['menu']) || in_array(65, $_SESSION['menu']) || $user['level_usr']==1) {
        ?><li class="nav-item" >
