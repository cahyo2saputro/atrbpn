<?php
    @$namafile="daftar nominatif Hak Link NOP ".$desa['nma_kel']." Block ".$desa['nama_blk'];
    ...
    <tbody>
        ...
        <tr>
         ...
         $datnjop = "";
           ...
           $datnop = '';$datnwp='';$datawp='';$dataop='';$datluas='';$datnjop='';
           foreach ($dd as $data) {
             $nop = createkodebpkad($st['id_kelurahan']).''.$desa['nama_blk'].''.$data['nosppt_dhkp'];
             $datnop .= "'".$nop.'<br>';
