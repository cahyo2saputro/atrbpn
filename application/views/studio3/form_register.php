	    ...
	    <div class="x_panel">
	        <div class="x_content">
				<div class="col-md-12 box-body">
					...
					<form id="form-tambah" method="post" action="<?php echo base_url()?><?php echo $this->uri->segment(1)?>/addregister/?search=<?= $this->input->get("search"); ?>">
	...
	$(document).ready(function () {
		...
		$('#nohak_nub').select2();
			...
			$('#btn-batal').click(function() {
							document.location='<?=base_url()?><?php echo $this->uri->segment(1)?>/register/?search='+<?=$block['idblk_blk']?>;
			});
