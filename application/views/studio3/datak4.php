...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  <?php
      ...
      if (in_array(132, $_SESSION['menu']) || in_array(47, $_SESSION['menu']) || in_array(28, $_SESSION['menu']) || in_array(65, $_SESSION['menu']) || in_array(80, $_SESSION['menu']) || $user['level_usr']==1) {
        ?><li class="nav-item" >
      ...
      if (in_array(53, $_SESSION['menu']) || in_array(52, $_SESSION['menu']) || in_array(69, $_SESSION['menu']) || in_array(78, $_SESSION['menu']) || $user['level_usr']==1) {
        ?><li class="nav-item" style='background:#fff'>
          <a class="nav-link" id="k4-tab" href="<?php echo base_url()?><?php echo $this->uri->segment(1)?>/k4/?search=<?php echo $idblk;?>" role="tab" aria-controls="profile" aria-selected="true">Data Sertipikat</a>
        </li><?php
      }
     ?>
</ul>
							...
							<div class="col-sm-12 table-responsive">
								<table id="data-staff" class="table table-bordered table-striped">
									<thead>
										<tr>
											<th rowspan='2'>No</th>
											<th colspan='7' style='text-align:center'>Data Sertipikat</th>
                      <th colspan='3' style='text-align:center'>Data DHKP</th>
                      <!-- <th>Jumlah</th> -->
                      <th rowspan='2'>SU</th>
                      <th rowspan='2'>Buku Tanah</th>
										</tr>
                    <tr>
											<th>No Hak</th>
											<th>No SU</th>
                      ...
                      if($st['jml']>1){
                        $dat['table'] = "tb_nub";
                        $dat['type'] = "multiple";
                  			$dat['column'] = "tb_dhkp.nosppt_dhkp,tb_dhkp.nama_dhkp";
                      ...
                      if($st['nosu_hak']){
                        ...
                        $jenisberkas = substr($st['nosu_hak'],0,2);

                        /* CEK SU */
                        $nma_file_su = cek_berkas($st['id_kelurahan']."_".$nosu."_".$thnsu,strtoupper($desa['nma_kec']),strtoupper($desa['nma_kel']),$jenisberkas);
                       ...
                       ?>
                      <td><?php if($berkassu['result']['status'] && (in_array(125, $_SESSION['menu']) || in_array(124, $_SESSION['menu']) || in_array(123, $_SESSION['menu']) || in_array(122, $_SESSION['menu']) || $user['level_usr']==1)){?><a href='#' data-toggle="control-sidebar"><i onclick="ajaxberkas('<?=$st['no_hak']?>','<?=$jenisberkas?>')" data-toggle="tooltip" title="Cek Surat Ukur" class="fa fa-book"></i></a> <?php }?></td>
                      <td><?php if($berkasbt['result']['status'] && (in_array(125, $_SESSION['menu']) || in_array(124, $_SESSION['menu']) || in_array(123, $_SESSION['menu']) || in_array(122, $_SESSION['menu']) || $user['level_usr']==1)){?><a href='#' data-toggle="control-sidebar"><i onclick="ajaxberkas('<?=$st['no_hak']?>','BTO')" data-toggle="tooltip" title="Cek Buku Tanah" class="fa fa-book"></i></a> <?php }?></td>
										 </tr>
										<?php } ?>
									</tbody>
								</table>
