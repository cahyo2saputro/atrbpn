...
<style>
body{
	background: url('https://encrypted-tbn0.gstatic.com/images?q=tbn%3AANd9GcRcxi6fbURiH_feGS2-Mye1L3tCZ08zLFKkeaAiwzQcfnIxPLdC') !important;
}
</style>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <form action="<?php echo base_url("guest/process"); ?>" method="post">
      ...
      <div class="form-group has-feedback">
          <?php //$capca; ?>
					<h4>Capcha</h4>
          <input style='text-align:center;font-size:20px;' type="text" readonly name="capca_valid" style="width:100%;" value="<?= $text_capca; ?>">
      </div>
    ...
    <center>
    <a href="#">&copy; copyright 2018 - e-BPN Semarang</a><br>
    </center>
