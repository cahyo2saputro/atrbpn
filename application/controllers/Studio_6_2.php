<?php
	...
	class Studio_6_2 extends CI_Controller
	{
		var $userdata = NULL;
		...
		public function edit($id,$idblk,$direct){
			...
			if ($this->input->post()) {
				...
				$this->referensi_model->save_logs($this->content['data']['user']['idusr_usr'],'tb_ptsl','e Pemetaan-'.$block['nma_kel'].'<br>'.$block['nama_blk'].'-'.$id,"Edit Luas PTSL dengan rincian ".displayArray($dataarray));
				...
				?>
				<meta http-equiv="refresh" content="1;<?php echo base_url();?>studio_6_2/data/<?php echo $direct; ?>?search=<?php echo $idblk; ?>">
				<?php
			}
			...
			cekkelurahan($user['idusr_usr'],$user['level_usr'],$block['idkel_blk']);
				...
				$this->content['data']['title'] = "e-Pemetaan : Edit Pengukuran Kelurahan ".$block['nma_kel']." Blok ".$block['nama_blk'];
				$this->content['data']['subtitle'] = array(array("e-Pemetaan","Studio6"),array("Daftar Blok","Studio_6_1/index/?search=".$block['idkel_blk']),array("Belum Sertipikat","Studio_6_2/data/?search=".$idblk),array("Edit Pengajuan","Studio_6_2/edit/".$id."/".$idblk));
      ...
      $this->content['studio'] = $this->crud_model->get_data($dat);
		...
		public function data()
		{
			...
			// SEARCHING
			$this->content['data']['param'] = array(array('NUB','nub_ptsl'),array('Nama','nma_pdk'),array('No. KTP','noktp_pdk'),array('NOP','nosppt_dhkp'),array('NIB','nib_ptsl'));

			$this->content['data']['title'] = "e-Pemetaan : Kelurahan ".$block['nma_kel']." Blok ".$block['nama_blk']." Belum Sertipikat";
			$this->content['data']['subtitle'] = array(array("e-Pemetaan","Studio6"),array("Daftar Blok","Studio_6_1/index/?search=".$block['idkel_blk']),array("Belum Sertipikat","Studio_6_2/data/?search=".$cari));
	      ...
	      $tdata['type'] = "single";
			...
			$config['base_url'] = base_url().'Studio_6_2/data/';
			...
			$dat['table'] = "tb_ptsl";
      $dat['type'] = "multiple";
			$dat['column'] = "tb_ptsl.nib_ptsl,tb_ptsl.noberkas_ptsl,tb_ptsl.nub_ptsl,tb_ptsl.luasfisik_ptsl,tb_ptsl.id_ptsl,tb_dhkp.nosppt_dhkp,tb_penduduk.noktp_pdk,tb_penduduk.nma_pdk,tb_block.idkel_blk,tb_block.nama_blk,tb_ptsl.idblk_ptsl";
      ...
      $this->content['studio'] = $this->crud_model->get_data($dat);
			...
			$this->content['load'] = array("studio6/data_studio_6_2");
			$this->load->view('adm',$this->content);
		}

		public function simpan_nibluas($id)
		{
			$user = $this->auth_model->get_userdata();

			$dataarray = array(
				'luasfisik_ptsl'   => $this->input->post('luas_ptsl'),
				'nib_ptsl'   => $this->input->post('nib_ptsl'),
				'noberkas_ptsl'   => $this->input->post('noberkas_ptsl'),
				'idusr_ptsl' => $user['idusr_usr']
			);
			$simpan = $this->crud_model->update('tb_ptsl',$dataarray,array('id_ptsl'=>$id));

			$this->referensi_model->save_logs($this->content['data']['user']['idusr_usr'],'tb_ptsl','e Pemetaan-0-'.$id,"Edit Luas PTSL dengan rincian ".displayArray($dataarray));
		...
		public function addregister(){
			...
			if ($this->input->post() && $this->input->post('nib_peta')!="") {
				...
				foreach ($dhkp as $dd) {
					...
					$this->referensi_model->save_logs($this->content['data']['user']['idusr_usr'],'tb_nub','e Pemetaan-'.$block['nma_kel'].'<br>'.$block['nama_blk'].'-'.$insert_id,"Menambahkan Data Register  dengan rincian ".displayArray($dataarray));
				}
				...
				?>
				<meta http-equiv="refresh" content="1;<?php echo base_url();?>studio_6_2/register/?search=<?php echo $this->input->get('search'); ?>">
				<?php
			...
			cekkelurahan($user['idusr_usr'],$user['level_usr'],$block['idkel_blk']);
				...
				$this->content['data']['title'] = "e-Pemetaan : Register Kelurahan ".$block['nma_kel']." Blok ".$block['nama_blk'];
				$this->content['data']['subtitle'] = array(array("e-Pemetaan","Studio6"),array("Daftar Blok","Studio_6_1/index/?search=".$block['idkel_blk']),array("Sudah Sertipikat","Studio_6_2/register/?search=".$idblk),array("Tambah Register","Studio_6_2/addregister/?search=".$idblk));
	...
	public function addnop($hak,$idblk){
		...
		if ($this->input->post() && $this->input->post('nib_peta')!="") {
			...
			?>
			<meta http-equiv="refresh" content="1;<?php echo base_url();?>studio_6_2/register/?search=<?php echo $idblk; ?>">
			<?php
		}else if($this->input->post() && $this->input->post('nib_peta')==""){
			?>
			<script>
		...
		cekkelurahan($user['idusr_usr'],$user['level_usr'],$block['idkel_blk']);
			...
			$this->content['data']['title'] = "e-Pemetaan : Tambah NOP ".$block['nma_kel']." Blok ".$block['nama_blk'];
			$this->content['data']['subtitle'] = array(array("e-Pemetaan","Studio6"),array("Daftar Blok","Studio_6_1/index/?search=".$block['idkel_blk']),array("Sudah Sertipikat","Studio_6_2/register/?search=".$idblk),array("Tambah NOP","Studio_6_2/addnop/".$hak."/".$idblk));
	...
	public function editregister($id,$idblk){
		...
		if ($this->input->post() && $this->input->post('nib_peta')!="") {
			...
			$this->content['data']['title'] = "e-Pemetaan : Edit Register Pengajuan Kelurahan ".$block['nma_kel']." Blok ".$block['nama_blk'];
			$this->content['data']['subtitle'] = array(array("e-Pemetaan","Studio6"),array("Daftar Blok","Studio_6_1/index/?search=".$block['idkel_blk']),array("Sudah Sertipikat","Studio_6_2/register/?search=".$idblk),array("Edit Register","Studio_6_2/editregister/".$id."/".$idblk));
		...
		public function register()
		{
			...
			$this->content['data']['title'] = "e-Pemetaan : Kelurahan ".$block['nma_kel']." Blok ".$block['nama_blk']." Sudah Sertipikat";
			$this->content['data']['subtitle'] = array(array("e-Pemetaan","Studio6"),array("Daftar Blok","Studio_6_1/index/?search=".$block['idkel_blk']),array("Sudah Sertipikat","Studio_6_2/register/?search=".$cari));
	      ...
	      $tdata['type'] = "single";
			...
			$config['base_url'] = base_url().'Studio_6_2/register/';
      ...
      $this->content['studio'] = $this->crud_model->get_data($dat);
		...
		public function dhkp()
		{
			...
			$this->content['data']['title'] = "e-Pemetaan : Kelurahan ".$block['nma_kel']." Blok ".$block['nama_blk']." DHKP";
			$this->content['data']['subtitle'] = array(array("e-Pemetaan","Studio6"),array("Daftar Blok","Studio_6_1/index/?search=".$block['idkel_blk']),array("DHKP","Studio_6_2/dhkp/?search=".$cari));
      ...
      $tdata['type'] = "single";
			...
			$config['base_url'] = base_url().'Studio_6_2/dhkp/';
			$config['total_rows'] = $ttdata['jumlah'];
			$config['uri_segment'] = 3;
			$config['reuse_query_string'] = TRUE;
			$config['per_page'] = 10;
      ...
      $this->content['studio'] = $this->crud_model->get_data($dat);
		...
		public function k4()
		{
			...
			$this->content['data']['title'] = "e-Pemetaan : Kelurahan ".$block['nma_kel']." Blok ".$block['nama_blk']." K4";
			$this->content['data']['subtitle'] = array(array("e-Pemetaan","Studio6"),array("Daftar Blok","Studio_6_1/index/?search=".$block['idkel_blk']),array("K4","Studio_6_2/k4/?search=".$cari));
	      ...
	      $tdata['type'] = "single";
			...
			$config['base_url'] = base_url().'Studio_6_2/k4/';
			$config['total_rows'] = $ttdata['jumlah'];
			$config['uri_segment'] = 3;
			$config['reuse_query_string'] = TRUE;
			$config['per_page'] = 10;
      ...
      $this->content['studio'] = $this->crud_model->get_data($dat);
		...
		public function deleteregister($kode)
		{
			...
			$this->referensi_model->save_logs($this->content['data']['user']['idusr_usr'],'tb_nub','e Pemetaan-0-'.$kode,"Menghapus Data Register dengan kode ".$kode);
