...
class Studioip4t extends CI_Controller
{
	var $userdata = NULL;
	...
	{
		$user = $this->auth_model->get_userdata();
		$this->content['data']['title'] = "IP4T";
		$this->content['data']['subtitle'] = array(array("IP4T","Studioip4t"));
		...
		$config['base_url'] = base_url().'Studioip4t/index/';
		...
		$this->content['load'] = array("studioip4t/data_studio");
