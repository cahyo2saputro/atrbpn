<?php
	...
	class Dusun extends CI_Controller
	{
		...
		function __construct()
		{
			...
			$this->content['data']['title_page'] = 'Dusun';
		...
		public function index()
		{
			...
			$this->content['data']['title'] = "Data Dusun";
			$this->content['data']['subtitle'] = array(array("Dusun","Dusun"));

      $this->content['kel']     =  $this->db->query("SELECT a.nma_kel, a.kd_full, a.kdpbb_kel , b.nma_kec ,a.id_kel FROM ms_dusun c LEFT JOIN ms_kelurahan a ON c.kdkel_dsn = a.kd_full LEFT JOIN ms_kecamatan b ON a.kdkec_kel = b.kd_kec")->result_array();

			$this->content['load'] = array("kelurahan/data_dusun");

			$this->load->view('adm',$this->content);
		}

		public function form_dusun()
		{
			$usr = $this->auth_model->get_userdata();
			$level_usr = $usr['level_usr'];
			if($level_usr != "1"){
			...
			if($status){
				$this->content['data']['title'] 	= "Form Edit Dusun";
				$this->content['data']['subtitle'] 	= array(array("Dusun","Dusun"),array("Edit Dusun","Dusun/form_dusun/".$status));
				...
				$this->content['data']['title'] 	= "Form Tambah Dusun";
				$this->content['data']['subtitle'] 	= array(array("Dusun","Dusun"),array("Tambah Dusun","Dusun/form_dusun"));
			...
			$this->content['load'] 				= array("kelurahan/form_dusun");
			$this->load->view('adm',$this->content);
		}
